...
open class Class10venuevenueIdsetlistsAPI {
     ...
     */
    open class func resource10VenueVenueIdSetlistsGetVenueSetlistsGET(venueId: String, p: Int? = nil, completion: @escaping ((_ data: JsonSetlists?,_ error: Error?) -> Void)) {
        resource10VenueVenueIdSetlistsGetVenueSetlistsGETWithRequestBuilder(venueId: venueId, p: p).execute { (response, error) -> Void in
  ...
  "itemsPerPage" : 20
     ...
     */
    open class func resource10VenueVenueIdSetlistsGetVenueSetlistsGETWithRequestBuilder(venueId: String, p: Int? = nil) -> RequestBuilder<JsonSetlists> {
