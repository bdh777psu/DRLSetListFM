...
open class Class10searchsetlistsAPI {
  ...
  "itemsPerPage" : 20
     ...
     */
    open class func resource10SearchSetlistsGetSetlistsGETWithRequestBuilder(artistMbid: String? = nil, artistName: String? = nil, artistTmid: Int? = nil, cityId: String? = nil, cityName: String? = nil, countryCode: String? = nil, date: String? = nil, lastFm: Int? = nil, lastUpdated: String? = nil, p: Int? = nil, state: String? = nil, stateCode: String? = nil, tourName: String? = nil, venueId: String? = nil, venueName: String? = nil, year: String? = nil) -> RequestBuilder<JsonSetlists> {
        ...
        let requestBuilder: RequestBuilder<JsonSetlists>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
